# GlobalJags generate_thumb_data Google Cloud Function
...
--trigger-resource sp24-41200-antweyer-gj-uploads
...
```
gsutil cp gs://sp23-globaljags-dev-sample-images/china/china1.jpeg gs://sp24-41200-antweyer-gj-uploads
```